...
If you are having particular problem with your Anon Wallet instalation, please first [search older
issues](https://github.com/anonymousbitcoin/anon-copay-wallet/issues) in order to learn if the issue is already reported. It could be fixed already.
...
provide the following information:
 ...
 - Which version of Anon Wallet are you using? (Check Anon Wallet version on the side menu)
 ...
 - Please check Anon Wallet logs (General Settings -> About Anon Wallet -> Session Logs). Look for
...
To open an issue go to [Github Issues](https://github.com/anonymousbitcoin/anon-copay-wallet/issues).
...
Please adhere to the coding conventions used throughout Anon Wallet (indentation, tests, etc.)
